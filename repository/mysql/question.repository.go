...
func (repo *repoQuestion) Create(question *domain.Question) error {
    _, err := repo.DB.Exec("INSERT INTO questions (test_id, content_question, image_url, audio_url, question_type, points) values (?, ?, ?, ?, ?, ?)", 
    question.TestID, question.ContentQuestion, question.ImageURL, 
